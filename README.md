...
https://your-cdn.example.com/v0.2.2/rsvp-reader.iife.js
...
<script src="https://unpkg.com/speed-reader-widget@0.2.2" defer></script>

<!-- jsDelivr, version-pinned -->
<script src="https://cdn.jsdelivr.net/npm/speed-reader-widget@0.2.2" defer></script>

<!-- ESM via esm.sh -->
<script type="module" src="https://esm.sh/speed-reader-widget@0.2.2"></script>
```
